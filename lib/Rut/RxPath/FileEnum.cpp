...
{
	bool GetFilesPaths(const std::string& msPath, std::vector<std::string>& vecList)
	{
	...
	bool GetFilesPaths(const std::wstring& wsPath, std::vector<std::wstring>& vecList)
	{
	...
	bool GetFileNames(const std::string& msFolder, std::vector<std::string>& vecList)
	{
		WIN32_FIND_DATAA findData = { 0 };
	...
	bool GetFileNames(const std::wstring& wsFolder, std::vector<std::wstring>& vecList)
	{
		WIN32_FIND_DATAW findData = { 0 };
	...
	{
		return FindFile(msPath.data());
	}

	bool FindFile(std::wstring_view wsPath)
	{
		return FindFile(wsPath.data());
	}
}